...
Bifur=[0 2 2 3;1 3 4 6;1 2 4 5;3 5 2 6;3 4 6 7;2 4 5 7;5 6 0 0]';
BCTypeAll=['u' 'B';'B' 'C';'B' 'B';'B' 'C';'B' 'C';'C' 'C';'C' 'T'];
DiamVec(1)=startDiam;
DiamVec(2)=DiamVec(1)*ratio_D_L^3;
DiamVec(3)=DiamVec(1)*ratio_D_L;
DiamVec(4)=DiamVec(3)*ratio_D_L^2;
DiamVec(5)=DiamVec(3)*ratio_D_L;
DiamVec(6)=DiamVec(4)/ratio_D_L;
DiamVec(7)=DiamVec(6)/ratio_D_L;
...
% Number of step
Nstep=4.8/dt;
inFileName='ASymNet1_IN_1.bcs';
outFileName='ASymNet1_OUT_1.bcs';
...
system('copy ASymNet1*.* E:\Projects\CPP\1DWin_MKL\1DWin_MKL\');
system('copy ASymNet1*.* E:\1DWin\SymNet\');